...
The Project Hub is your central dashboard for navigating all SidStack features.
...
|------|----------|-------------|
| Project Hub | Cmd+1 | Dashboard overview |
| Task Manager | Cmd+2 | Create and track tasks |
